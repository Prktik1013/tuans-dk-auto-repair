# d83f4842-027a-44f1-ba4a-a68603c048c2 implementation handoff
...
- `mcps/open-design/tools/cancel_run.json`
- `mcps/open-design/tools/create_artifact.json`
- `mcps/open-design/tools/create_project.json`
- `mcps/open-design/tools/delete_file.json`
- `mcps/open-design/tools/delete_project.json`
- `mcps/open-design/tools/get_active_context.json`
- `mcps/open-design/tools/get_artifact.json`
- `mcps/open-design/tools/get_file.json`
- `mcps/open-design/tools/get_project.json`
- `mcps/open-design/tools/get_run.json`
- `mcps/open-design/tools/list_agents.json`
- `mcps/open-design/tools/list_files.json`
- `mcps/open-design/tools/list_plugins.json`
- `mcps/open-design/tools/list_projects.json`
- `mcps/open-design/tools/list_skills.json`
- `mcps/open-design/tools/search_files.json`
- `mcps/open-design/tools/start_run.json`
- `mcps/open-design/tools/write_file.json`
- `mrb3zni4-BRIEF.md`
- `mrb3zni5-creative-angle.md`
- `mrb3zni6-DESIGN-BRIEF.md`
- `mrb3zni6-od-commission.txt`
- `mrb3zni6-OPERATOR-SHEET.md`
- `mrb3zni6-research-notes.md`
